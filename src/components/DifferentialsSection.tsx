...
const items = [
  { icon: Building2, title: "Prédio com elevador", desc: "Comodidade e acessibilidade" },
  { icon: Shield, title: "Portaria 24h", desc: "Segurança durante todo o período" },
  { icon: MapPin, title: "Localização estratégica", desc: "No coração do circuito" },
  { icon: Users, title: "Até 4 pessoas", desc: "Espaço ideal para seu grupo" },
];
